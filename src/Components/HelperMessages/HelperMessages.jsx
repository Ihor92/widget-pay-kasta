export const tooltipMessages = {
  cardOwnerTooltip: `Прізвище та ім'я людини <br /> на яку випущена карта. <br /> Для іменних карта — <br /> нанесено на карту.`,
  cvvTooltip: "Три цифри що знаходяться <br /> з іншого боку карти.",
